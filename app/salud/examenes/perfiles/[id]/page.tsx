...
export default function DetallePerfilEmoPage() {
  ...
  useEffect(() => {
    ...
    configEmoService
      ...
      .then((p) => {
        ...
        setCostoUnitario(String(p.costoUnitario ?? 0));
        setRegistradoPor(p.registradoPorNombre ?? '');
      })
      .catch((e) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setSubmitting(true);
      await configEmoService.updatePerfil(id, {
        nombre: nombre.trim(),
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input value={registradoPor} disabled className="bg-slate-50" />
          </div>
